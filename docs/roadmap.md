...
- [ ] 1.4 Клавиатура: скан-коды, маппинг Cmd/Option, настраиваемые сочетания — и сочетание для «Отключиться»: с 1.2 у пункта его нет, чтобы ⌘-комбинации доставались удалённому рабочему столу — _добавлено 2026-09-25_
